...
● Observation 2: Random forest & GBR have performed equally good in terms of adjusted r2. So ,we are getting the best results from Gradient Boosting and Random Forest.
...
● After performing variable importance analysis to find the most significant variables for all the models developed with the given data sets. We are getting the best results from Gradient Boosting and Random Forest.
